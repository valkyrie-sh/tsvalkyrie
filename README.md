...
```sh
npm install git+ssh://git@github.com:valkyrie-sh/tsvalkyrie.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/valkyrie-sh/tsvalkyrie/issues) with questions, bugs, or suggestions.
